...
#define GET_NAME(Object) (Object ? Object->GetName() : TEXT("None"))
	Context.AddTag(FAssetRegistryTag("FirstCustomMesh", GET_NAME(FirstCustomStaticMesh), FAssetRegistryTag::TT_Alphabetical));
	Context.AddTag(FAssetRegistryTag("SecondCustomMesh", GET_NAME(SecondCustomStaticMesh), FAssetRegistryTag::TT_Alphabetical));
	...
	Context.AddTag(FAssetRegistryTag("CustomDataAsset", GET_NAME(CustomDataAsset), FAssetRegistryTag::TT_Alphabetical));
#undef GET_NAME
#endif
}
